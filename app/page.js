	...
	return (
		<>
			<section className='text-center'>
				<h1 className='text-blue-600 text-8xl font-black mb-20 mt-10'>Hello&#44; I&rsquo;m nuing</h1>
			</section>
			<section className='flex justify-center'>
				<div className='grow-1 m-16'>
					<h2 className='text-blue-600 font-bold text-5xl'>I&rsquo;m Front-end Developer</h2>
